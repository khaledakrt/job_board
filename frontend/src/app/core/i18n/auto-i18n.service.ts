...
const STATIC_TEXT_TRANSLATIONS: Record<string, string> = {
  ...
  'Modifier la note': 'Update rating',
  'Attribuer cette note au candidat ?': 'Apply this rating to the candidate?',
  'Transition de statut non autorisée pour cette candidature.': 'This status transition is not allowed for this application.',
  'Choisissez la date et l’heure de l’entretien.': 'Choose the interview date and time.',
  'Candidature rejetée et déplacée dans Archives.': 'Application rejected and moved to Archives.',
  'Candidature mise à jour — message envoyé par e-mail au candidat.': 'Application updated - message sent to the candidate by email.',
  'Candidature mise à jour — message enregistré, e-mail non envoyé.': 'Application updated - message saved, email not sent.',
  'Candidature mise à jour.': 'Application updated.',
  'Échec de la mise à jour.': 'Update failed.',
  'Entretien confirmé par le candidat': 'Interview confirmed by the candidate',
  'Le candidat demande un autre créneau': 'The candidate is requesting another time slot',
  'Contacter par e-mail': 'Contact by email',
  'Appeler le candidat': 'Call candidate',
  'Proposer une nouvelle date': 'Propose a new date',
  'Postulé': 'Applied',
  'Salaire min.': 'Min. salary',
  'Aperçu CV': 'Resume preview',
  'Message optionnel envoyé lors du prochain changement d’étape…': 'Optional message sent at the next stage change...',
  'Ce message part uniquement quand vous changez l’étape depuis la modale.': 'This message is sent only when you change the stage from the modal.',
  ...
  'E-mail de contact RH *': 'HR contact email *',
  'Choisir si l\'e-mail est visible sur la page publique de l\'entreprise': 'Choose whether the email is visible on the public company page',
  'Choisir si le téléphone est visible sur la page publique de l\'entreprise': 'Choose whether the phone number is visible on the public company page',
  'Visible sur votre page entreprise publique.': 'Visible on your public company page.',
  'Non affiché aux candidats sur la page entreprise.': 'Not shown to candidates on the company page.',
  'E-mail professionnel valide requis.': 'Valid professional email required.',
  'Secteur d’activité *': 'Industry *',
  'Effectif *': 'Company size *',
  'Présentation de l’entreprise *': 'Company presentation *',
  'E-mail actuel': 'Current email',
  ...
  'Masquer / Archiver': 'Hide / Archive',
  'Masquer la candidature': 'Hide application',
  'Impossible de masquer la candidature.': 'Unable to hide the application.',
  'Confirmer l’entretien': 'Confirm interview',
  'Confirmer votre présence à cet entretien ? Le recruteur sera notifié.': 'Confirm your attendance for this interview? The recruiter will be notified.',
  'Confirmer ma présence': 'Confirm my attendance',
  'Demander un autre créneau': 'Request another time slot',
  'Message au recruteur': 'Message to recruiter',
  'Expliquez pourquoi ce créneau ne convient pas et proposez vos disponibilités.': 'Explain why this time slot does not work and suggest your availability.',
  'Vous avez confirmé votre présence au recruteur.': 'You confirmed your attendance to the recruiter.',
  'Vous avez demandé un autre créneau au recruteur.': 'You requested another time slot from the recruiter.',
  'Ajoutez un message pour demander un autre créneau.': 'Add a message to request another time slot.',
  'La limite d’échanges pour cet entretien est atteinte.': 'The exchange limit for this interview has been reached.',
  'Limite d’échanges atteinte pour cet entretien. Vous pouvez confirmer ou contacter directement le recruteur.': 'Exchange limit reached for this interview. You can confirm or contact the recruiter directly.',
  'Impossible de confirmer l’entretien.': 'Unable to confirm the interview.',
  'Impossible d’envoyer votre demande.': 'Unable to send your request.',
