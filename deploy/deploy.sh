...
#
# Variables optionnelles : APP_ROOT, REPO_URL, USE_AAPANEL=yes|no
...
USE_AAPANEL="${USE_AAPANEL:-yes}"

[[ -n "${DB_PASSWORD:-}" ]] || { echo "ERREUR: export DB_PASSWORD='...'"; exit 1; }
[[ -n "${PUBLIC_URL:-}" ]] || { echo "ERREUR: export PUBLIC_URL=http://VOTRE_IP"; exit 1; }
...
echo " Test    : candidate@test.com / Test1234!"
echo "=============================================="
